    ...
    return (
      <div className="flex flex-col items-center gap-8 py-8">
        <motion.div
          ...
          className="flex h-24 w-24 items-center justify-center rounded-full bg-gradient-to-br from-gold-400 to-gold-600 text-navy-900 shadow-glass-lg"
        >
    ...
    <div className="flex flex-col gap-6">
      <div className="flex items-center justify-between">
        ...
        <motion.div
          initial={{ scale: 0.8 }}
          animate={{ scale: 1 }}
          className="flex items-center gap-2 rounded-full bg-gradient-to-r from-gold-400 to-gold-600 px-4 py-1.5 text-sm font-semibold text-navy-900 shadow-soft"
        >
